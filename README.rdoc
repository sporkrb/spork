...
You may find this wiki page useful for common ways to battle a variety of common pre-loading issues: https://github.com/sporkrb/spork/wiki/Spork.trap_method-Jujitsu
...
* Aslak Hellesøy - for the fine Cucumber testing framework, and for much collaboration getting cucumber working with spork.
